...
REM any settings that start with PR_ followed by the parameter name override settings passed in using the "--" syntax below
...
REM log files are found: C:\Windows\System32\LogFiles\Apache

set BAT_PATH=%~dp0
set SERVICE_NAME=Nabu
set PRR_INSTALL=%BAT_PATH%nabu.exe
